...
const authService = new auth_services_1.AuthService(authRepository, otpRepository, adminRepository, instructorRepository, courseRepository, orderRepository, progressRepository, walletRepository, complaintRepository, notificationRepository, certificateRepository, certificateService);
...
router.patch("/profile", (0, authRole_1.default)(["user"]), multer_1.default.single("profilePicture"), authController.updateProfile.bind(authController));
...
router.get("/purchased-courses", (0, authRole_1.default)(["user"]), authController.purchasedCourses.bind(authController));
router.post("/change-password", (0, authRole_1.default)(["user"]), authController.changePassword.bind(authController));
router.get("/courseinstructor/:instructorId", (0, authRole_1.default)(["user"]), authController.courseInstructorView.bind(authController));
router.get("/certificates/:id", (0, authRole_1.default)(["user"]), authController.getCertificates.bind(authController));
