...
const authService = new auth_services_1.AuthService(authRepository, otpRepository, adminRepository, instructorRepository, courseRepository, orderRepository, progressRepository, walletRepository, complaintRepository, notificationRepository, certificateRepository, certificateService, categoryRepository);
const authController = new auth_controller_1.Authcontroller(authService, messageService);
...
router.get("/chats/unread-counts", (0, authRole_1.default)(["user"]), authController.getUnreadCounts.bind(authController));
router.post("/messages/mark-as-read/:chatId", (0, authRole_1.default)(["user"]), authController.markRead.bind(authController));
