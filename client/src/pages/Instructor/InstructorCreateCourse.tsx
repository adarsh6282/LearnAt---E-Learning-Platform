...
const InstructorCreateCourse: React.FC = () => {
  ...
  useEffect(() => {
    const getCategories = async () => {
      try {
        const data = await getAllCategoriesS();
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const lecturesData = courseData.lectures.map(({ videoFile, ...rest }) => rest);
      ...
      const response = await createCourseS(formData,token!)
      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8">
        ...
        <div className="space-y-6">
          ...
          <div className="border-t border-gray-200 pt-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Add Lectures</h2>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handleLectureInputChange('title', e.target.value)}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handleLectureInputChange('duration', e.target.value)}
                      placeholder="e.g., 30"
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    />
                  </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) => handleLectureInputChange('description', e.target.value)}
            ...
            <div className="space-y-4">
              ...
              {courseData.lectures.map((lecture, index) => (
                <div key={lecture.id} className="bg-white border border-gray-200 rounded-lg p-4">
